              ...
              <div class="col-lg-11 mx-4">
                <div class="card-body">
                  <div class="text-left my-1">
                    ...
                    <code>&#42 Isi sesuai dengan jadwal praktikum yang sudah disahkan oleh staff.</code><br>
                    <code>&#42 Apabila ada perubahan silahkan di submit kembali.</code><br>
                  ...
                  <div class="modal-footer">
                    <a class="btn btn-secondary" type="button" href="<?=base_url('penjadwalan/jadwal_praktik')?>">Batal</a>
