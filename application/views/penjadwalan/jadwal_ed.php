                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 mx-auto" style="max-width: 720px;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-<?= $color ?>">Jadwal Kuliah</h6>
                        </div>
                        <?= $this->session->flashdata('jadwal');
                        $tanggal_isi = '-';
                        $tanggal_edit = '-';
                        foreach ($cek->result_array() as $isi) :
                            $tanggal_isi = $isi['waktu_input'];
                            $tanggal_edit = $isi['waktu_edit'];
                        endforeach;
                        ?>
                            ...
                            <div class="col-lg-11 mx-4">
                                <div class="card-body">
                                    <div class="text-left my-1">
                                        <code>Catatan:</code><br>
                                        <code>&#42 Isi sesuai dengan jadwal kuliah kalian!</code><br>
                                        <code>&#42 Apabila tidak ada kegiatan maka centang boxnya.</code><br>
                                        <code>Tanggal Input: <?= $tanggal_isi ?></code><br>
                                        <code>Tanggal Edit: <?= $tanggal_edit ?></code>
                                    </div>
                                    <form class="user" method="post" action='<?= base_url('penjadwalan/submit') ?>'>
                                        <table class="table table-responsive shadow table-bordered table-light">
                                            <thead>
                                                            ...
                                                            <td>
                                                                <div class="text-center">
                                                                    <div class="form-check form-check-inline">
                                                                        <input class="form-check-input" type="checkbox" name="<?= $day ?>_s<?= $shift ?>" id="<?= $day ?>_s<?= $shift ?>" value="1" <?= $check ?>>
                                                                        <label class="form-check-label" for="<?= $day ?>_s<?= $shift ?>">Kosong</label>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        <?php endforeach; ?>
                                        ...
                                        <div class="modal-footer">
                                            <a class="btn btn-secondary" type="button" href="<?= base_url('penjadwalan') ?>">Batal</a>
